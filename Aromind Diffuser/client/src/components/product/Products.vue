<template>
    <div class="row">
        ...
        <my-product v-for="product in products" v-bind:key="product.id" @delete-product="deleteProduct(product)" :authenticatedUser="authenticatedUser" :product="product"></my-product>
    </div>
</template>
